...
class LogicCube:
    ...
    def apply(self, move):
        ...
        elif m == 'B':  self._cw('B');  self._cycle([('U',2),('U',1),('U',0)],[('L',0),('L',3),('L',6)],[('D',8),('D',7),('D',6)],[('R',2),('R',5),('R',8)])
        elif m == "B'": self._ccw('B'); self._cycle([('R',8),('R',5),('R',2)],[('D',6),('D',7),('D',8)],[('L',6),('L',3),('L',0)],[('U',0),('U',1),('U',2)])
